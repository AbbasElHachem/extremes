...
class Plot_Map(object):
    ...
    **kwargs
    ...
    def __init__(self,
        ...
        # changing this, changes the space of the basemap plot inside the
        # figure
        if title:
        ...
        # lon_0, lat_0 are the central longitude and latitude of the
        # projection.
...
#                self.ax2 = self.fig.add_axes([0.85, 0.1, 0.05, 0.8])
        ...
        if kwargs.get('boarder_line', True):
            ...
            shapefile_path = os.path.join(
                self.basepath, '02_Import', 'countries')
        ...
        # if keywords is dictionary use it to describe the meridians and
        # parallels
    ...
    def plot_raster(self, data, lons, lats, *args, **kwargs):
        ...
        *args, **kwargs [from plt.pcolor()]
        ...
        plot = self.m.pcolormesh(
            lons, lats, mdata, latlon=True, *args, **kwargs)
