...
# # plot original data
# plt.scatter(xvals_below_curve0, yvals_below_curve0, c='pink', alpha=0.5,
#             marker='x', label=('First Neighbor data below curve'),
#             s=marker_size_below_curve)
# plt.scatter(xvals_below_curve1, yvals_below_curve1, c='lightblue', alpha=0.5,
#             marker='x', label=('Second Neighbor data below curve'),
#             s=marker_size_below_curve)
#
# # # plot original data
# plt.scatter(xvals_above_curve0, yvals_above_curve0, c='r', alpha=0.35,
#             marker='o', label=('First Neighbor data above curve'),
#             s=marker_size_below_curve)
# plt.scatter(xvals_above_curve1, yvals_above_curve1, c='b', alpha=0.35,
#             marker='o', label=('Second Neighbor data above curve'),
#             s=marker_size_below_curve)
# # # plot curve
# #
# plt.scatter(x0_gd_corr, y_fitted_shifted0, c='m', alpha=0.5,
#             marker='x', label=('Fitted function Nbr1'),
#             s=marker_size_curve)
# plt.scatter(x1_gd_corr, y_fitted_shifted1, c='c', alpha=0.5,
#             marker='d', label=('Fitted function Nbr2'),
#             s=marker_size_curve)
# plt.show()
...
plt.title('Keeping %s %d stations: Indicator correlation with distance'
          ...
          % (data_source0,  stns_keep_all_final_new.shape[0],
              percent, time_freq))
plt.savefig(save_dir /  # filtered_2_neighbors_data
            (r'_%s_%s_%s_percent_indic_corr_freq_%s_filtered_pearson.png'
