...
(y_fitted_shifted1, xvals_below_curve1,
 ...
 yvals_above_curve1, stnbelow1, stnabove1) = fit_curve_get_vals_below_curve(
    x=x1_gd_corr, y=y1_gd_corr, func=func, stns=s1_gd_corr, shift_per=0.25)
...
stns_keep_al_sr = pd.DataFrame(data=stns_keep_all,
                               columns=['Stations'])
...
plt.savefig(save_dir /
            (r'_%s_%s_%s_percent_indic_corr_freq_%s_filtered_all_neighbors_data_s0.png'
