...
#
                ...
                if (df_common1.values.shape[0] > 0 and
                    ...
                    #
                    try:
                        plt_bar_plot_2_stns(stn_id, stn_2_id, min_dist,
                                            df_common1, df_common2,
                                            tem_freq,
                                            out_save_dir)
                        plt_scatter_plot_2_stns(stn_id, stn_2_id, min_dist,
                                                df_common1, df_common2,
                                                ppt_thr2,
                                                tem_freq,
                                                out_save_dir)
                        plot_end_tail_cdf_2_stns(stn_id, stn_2_id, min_dist,
                                                 df_common1, df_common2,
                                                 tem_freq, ppt_thr,
                                                 out_save_dir)
                        plot_ranked_stns(stn_id, stn_2_id, min_dist,
                                         df_common1, df_common2,
                                         tem_freq,
                                         out_save_dir)
