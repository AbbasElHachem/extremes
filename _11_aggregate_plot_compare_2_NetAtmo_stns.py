...
path_to_distance_mtx_Netatmo_ppt_Netatmo_ppt = (
    r"X:\hiwi\ElHachem\Prof_Bardossy\Extremes\NetAtmo_BW"
    r"\distance_mtx_in_m_NetAtmo_ppt_Netatmo_ppt.csv")
...
def compare_cdf_two_stns(netatmo_ppt_df_file,
                         path_distance_mtx_netatmo_netamo):
    ...
    in_df_distance_netatmo_dwd = pd.read_csv(path_distance_mtx_netatmo_netamo,
                                             sep=';',
                                             index_col=0)
    ...
    #                 stn_id, coords_df_file, x_col_name, y_col_name)
                assert stn_id != stn_2_id, 'wrong neighbour selected'
                idf2 = in_netatmo_stns_df.loc[:, stn_2_id]
...
if __name__ == '__main__':
    ...
    compare_cdf_two_stns(
        netatmo_ppt_df_file=path_to_ppt_netatmo_data,
        path_distance_mtx_netatmo_netamo=path_to_distance_mtx_Netatmo_ppt_Netatmo_ppt
    )
