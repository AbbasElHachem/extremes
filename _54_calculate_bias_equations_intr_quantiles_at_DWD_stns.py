...
#         raise Exception
    ...
    B1_dwd = calculate_overall_bias(df_dwd_edf, df_dwd)
    B1_dwd_netatmo = calculate_overall_bias(df_dwd_edf, df_netatmo_dwd)
    ...
    B2_dwd = calculate_temporal_bias(df_dwd_edf, df_dwd)
    B2_dwd_netatmo = calculate_temporal_bias(df_dwd_edf, df_netatmo_dwd)
    ...
    B3_dwd = calculate_spatial_bias(df_dwd_edf, df_dwd)
    B3_dwd_netatmo = calculate_spatial_bias(df_dwd_edf, df_netatmo_dwd)
    ...
    B4_dwd = calculate_squared_error(df_dwd_edf, df_dwd)
    B4_dwd_netatmo = calculate_squared_error(df_dwd_edf, df_netatmo_dwd)
